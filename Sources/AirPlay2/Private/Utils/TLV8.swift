...
func decodeTVL8<Key>(_ data: Data) throws -> [(Key, Data)] where Key: RawRepresentable, Key.RawValue == UInt8 {
    var result = [(Key, Data)]()
...
func encodeTVL8<Key>(_ array: [(Key, Data)]) -> Data where Key: RawRepresentable, Key.RawValue == UInt8 {
    var result = Data()
